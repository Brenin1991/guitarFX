...
public class Objeto{
    ...
    private boolean verificaAcao = false;
    ...
    public Boolean getVerificaAcao() {
        return verificaAcao;
    }

    public void setVerificaAcao(Boolean verificaAcao) {
        this.verificaAcao = verificaAcao;
    }
    ...
    public void mover(){
        ...
        transicao.setDuration(Duration.seconds(3));
